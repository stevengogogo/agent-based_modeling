...
;;...CELL...................................................................................
  ...
  foreach arrmito
  [ ?1 ->
    set totmass totmass + [size] of ?1 / tot_mitochondria_mass
    if ( [size] of ?1 <= 1 ) [ set small small + [size] of ?1 / tot_mitochondria_mass ]
    if ( [size] of ?1 > 1 and [size] of ?1 <= 2 ) [ set mid mid + [size] of ?1 / tot_mitochondria_mass ]
    if ( [size] of ?1 > 2 and [size] of ?1 <= max_mito_mass ) [ set big big + [size] of ?1 / tot_mitochondria_mass ]
  ]
        ...
        [
          ...
          [
            ...
            [
              ...
              foreach totmassGreenTemp [ ?1 -> set totmassGreen totmassGreen + ?1 ]
            ]
          ]
        ]
        ...
        if ( any? mitos with [color = blue] )
          [
            ...
            [
              ...
              foreach totmassLowTemp [ ?1 -> set totmassLow totmassLow + ?1 ]
            ]
          ]
      ]
      ...
      [
        ...
        ask one-of mitos with [color = blue]
          [
            ...
            foreach totmassHighTemp [ ?1 -> set totmassHigh totmassHigh + ?1 ]
          ]
      ]
  ...
  foreach arrmitoDam [ ?1 -> set totmassDam totmassDam + [size] of ?1 / tot_mitochondria_mass ]
...
to go
  ...
  [ ?1 ->
    ...
    if ( [size] of ?1 > 1 and [size] of ?1 <= 2 ) [ set mid mid + [size] of ?1 / tot_mitochondria_mass ]
    if ( [size] of ?1 > 2 and [size] of ?1 <= max_mito_mass ) [ set big big + [size] of ?1 / tot_mitochondria_mass ]
    if ( [color] of ?1 = green ) [ set totmassGreen totmassGreen + [size] of ?1 / tot_mitochondria_mass ]
  ]
